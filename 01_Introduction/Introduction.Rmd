...
- Substance:
  - How to establish **causality** in data analysis.
  - How to critically examine causal statements in research and journalism.


- Methods:
    - Learn various econometric tools: Randomized control trial, regression, instrumental variable, difference-in-differences, regression discontinuity, and simple structural estimation
    - Conduct empirical analysis using **R language**.
...
- Causality (因果): X causes/affects/impacts Y
...
- Data analysis aims to understand what is going on in reality.
    - Test whether theoretical prediction is true.
    - Determine the sign of ambiguous theoretical prediction.
    

- Data analysis starts with **description** of data.
...
- Suppose that X and Y are moving together (**correlated, 相関**).
...
- Questions:
  - Does this really mean “X causes Y”?
