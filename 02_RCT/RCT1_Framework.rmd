...
-   Define **potential outcomes**
    -   $Y_{1i}$: outcome for $i$ when she is treated
    -   $Y_{0i}$: outcome for $i$ when she is not treated 
...
- Let $D_i$ be whether go to a college.
- $Y_{1i}$: potential income if $i$ goes to college, $Y_{0i}$ potential income if not
- $Y_i$: actual observed outcome

|        | $Y_{1i}$       | $Y_{0i}$      | $D_i$ | $Y_i$ |
| ------ | ------------- | ------------- | ----- | ----- |
| Adam   | 80000 USD | 70000 USD | 1     |       80000 USD|
| Bob    | 70000 USD | 60000 USD | 0     |       60000 USD|
| Cindy  | 90000 USD | 70000 USD | 1     |       90000 USD|
| Debora | 80000 USD | 60000 USD | 0     |       70000 USD|
...
-   **Individual treatment effect** $Y_{1i}-Y_{0i}$
    ...
    -   Individual treatment effect cannot be obtained due to the fundamental problem (see next).
...
-   Assume that
    ...
    2.  constant (homogeneous) treatment effect, 
...
- However, can never observe $Y_{0i}$ and $Y_{1i}$ **simultaneously**.
  - Ex: Cannot know Adam's income if he had not attended a college.
...
- Goal: Estimate treatment effect parameters (AET, ATT, conditional ATE, etc)

- The simplest way is to compare average outcomes between treatment and control group
...
- Simple Difference: $E[Y_{i}|D_{i}=1]-E[Y_{i}|D_{i}=0] = 85000 - 60000 = 25000$

- ATT: $E[Y_{1i}-Y_{0i}|D_{i}=1] =  ( (80000-70000) + (90000-70000) )/2 = 15000$

- Bias: $E[Y_{0i}|D_{i}=1]-E[Y_{0i}|D_{i}=0] = 70000 - 60000 = 10000$
...
---
## Example: A/B Test in Fund Raising by President Obama
...
- [あの大統領も140%の成果改善。アメリカ大統領とA/Bテストの意外な関係](https://juicer.cc/articles/archives/1273/)
...
## Testing the difference of average between two groups 
